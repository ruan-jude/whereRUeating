...
# This should be included in a .gitignore

# You know what I'll just upload this so I don't have to explain why someone's cloned repository/local copy
# can't access the database at all.
